...
import { ArrowLeft, Droplets, Thermometer, Sprout } from "lucide-react";
...
type Prediction = {
  "Crop Type": string; // añade esta línea
  "Growth Period": number;
  "Soil Type": string;
  "Soil Moisture": number;
  "Soil Temperature": number;
  "Soil pH": number;
  "Soil Nitrogen": number;
  "Soil Phosphorus": number;
  "Soil Potassium": number;
  Precipitation: number;
  Temperature: number;
  Humidity: number;
  score: number;
...
export default function ResultsClient() {
  ...
  const cropData = results?.predictions || [];
